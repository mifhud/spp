...
class SiswaSearch extends Siswa
{
    ...
    {
        return [
            [['nis', 'nama', 'telepon', 'alamat', 'jenis_kelamin', 'tempat_lahir', 'tanggal_lahir', 'wali', 'email_wali'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'kelas_id_kelas' => $this->kelas_id_kelas,
        ...
        $query->andFilterWhere(['like', 'nis', $this->nis])
            ...
            ->andFilterWhere(['like', 'email_wali', $this->email_wali]);
